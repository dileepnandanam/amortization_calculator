...
class Amortization::Strategies::Extended3MonthInterestOnlyTest < ActiveSupport::TestCase
  test 'should give correct number of schedule items' do
    ...
    schedule_items = Amortization::Strategies::Extended3MonthInterestOnly.new(
      terms, principal, anual_rate, disbursement_date
    ).build
    assert_equal schedule_items.count, terms + 3
  end
